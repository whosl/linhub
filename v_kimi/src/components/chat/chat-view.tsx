            ...
            <div className="mx-auto mt-2 grid max-w-2xl grid-cols-2 gap-2 px-4 sm:grid-cols-3">
              {emptyPrompts.map((s, i) => (
                <motion.button
                  ...
                  className="glass rounded-xl px-3 py-2.5 text-left text-xs transition-all duration-200 hover:-translate-y-0.5 hover:shadow-[var(--shadow-lift)] hover:ring-1 hover:ring-primary/30"
                >
  ...
  return (
    <div className="relative flex h-full min-h-0 overflow-hidden">
      ...
      >
        ...
        >
          <div className="mx-auto flex max-w-3xl flex-col gap-6 px-4 pb-6 pt-[104px]">
