  ...
  return (
    <>
      ...
      <button
        ...
        className="my-1.5 -ml-2.5 flex items-center gap-2 rounded-full px-2.5 py-1 text-[13px] text-muted-foreground transition-colors hover:bg-accent/60 hover:text-foreground"
      >
    ...
    <div className="mt-2.5 flex flex-wrap gap-1.5">
      {sources.map((s, i) => (
        <a
          ...
          className="group/source inline-flex max-w-[220px] items-center gap-1.5 rounded-full bg-muted/60 px-2.5 py-1 text-xs text-muted-foreground transition-colors hover:bg-accent hover:text-foreground"
        >
          {faviconUrl(s.url) ? (
