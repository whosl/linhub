            ...
            {mode === "preview" ? (
              <>
                ...
                <button
                  ...
                  aria-label="缩小"
                  className="flex size-9 items-center justify-center rounded-full border border-white/15 bg-white/10 text-white backdrop-blur-md transition-all hover:bg-white/25 active:scale-95"
                >
                ...
                {onEdited && (
                  <button
                    ...
                    aria-label="编辑图片"
                    className="flex size-9 items-center justify-center rounded-full bg-brand text-sm font-medium text-white shadow-[0_2px_10px_rgb(108_92_231/0.4)] transition-all hover:brightness-110 active:scale-95 sm:size-auto sm:gap-1.5 sm:px-3.5 sm:py-2"
                  >
                ...
                <button
                  ...
                  aria-label="下载图片"
                  className="flex size-9 items-center justify-center rounded-full border border-white/15 bg-white/10 text-sm font-medium text-white backdrop-blur-md transition-all hover:bg-white/25 active:scale-95 sm:size-auto sm:gap-1.5 sm:px-3.5 sm:py-2"
                >
                ...
                <button
                  ...
                  aria-label="关闭"
                  className="ml-auto flex size-9 items-center justify-center rounded-full border border-white/15 bg-white/10 text-white backdrop-blur-md transition-all hover:bg-white/25 active:scale-95"
                >
              ...
              <>
                ...
                <button
                  ...
                  className={cn(
                    ...
                    mask.tool === "brush" ? "bg-brand text-white shadow-[0_2px_8px_rgb(108_92_231/0.4)]" : "bg-white/10 text-white hover:bg-white/20"
                  )}
                >
                ...
                <button
                  ...
                  className={cn(
                    "flex h-8 items-center justify-center gap-1.5 rounded-lg px-2 text-sm font-medium transition-colors sm:px-3",
                    mask.tool === "eraser" ? "bg-brand text-white shadow-[0_2px_8px_rgb(108_92_231/0.4)]" : "bg-white/10 text-white hover:bg-white/20"
                  )}
                >
