...
export function PptStudioBriefCard({
  ...
  return (
    <section className="my-2 w-full max-w-xl overflow-hidden rounded-2xl border bg-card shadow-[var(--shadow-card)]">
      <header className="flex items-start gap-3 border-b bg-muted/25 p-4">
        <span className="flex size-9 shrink-0 items-center justify-center rounded-xl bg-brand text-white shadow-[0_2px_8px_rgb(108_92_231/0.35)]">
        ...
        {!snapshot && !error ? (
          ...
          <>
            ...
            <div className="flex gap-2">
              ...
              <Button type="button" className="btn-brand flex-1 border-0" onClick={submit} disabled={submitting || cancelling || !snapshot}>
