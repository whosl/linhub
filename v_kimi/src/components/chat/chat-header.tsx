...
export function ChatHeader({
  ...
  return (
    <>
      <div className="pointer-events-none absolute inset-x-0 top-0 z-10 h-24 bg-gradient-to-b from-background via-background/85 to-transparent backdrop-blur-md [mask-image:linear-gradient(to_bottom,black_35%,transparent)]" />
      <div className="pointer-events-none absolute inset-x-0 top-3 z-20">
        <div className="mx-auto flex w-full max-w-3xl min-w-0 items-start gap-2 px-4">
          ...
          <div className="ml-auto flex min-w-0 flex-1 items-start justify-end gap-2">
            ...
            <div className="glass-strong pointer-events-auto flex h-9 shrink-0 items-center gap-1 rounded-xl p-1">
