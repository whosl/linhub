    ...
    <Dialog open={expanded} onOpenChange={setExpanded}>
      <div className="my-1.5 first:mt-0">
        <button
          ...
          className="flex max-w-full items-center gap-2 -ml-2.5 rounded-full px-2.5 py-1 text-[13px] text-muted-foreground transition-colors hover:bg-accent/60 hover:text-foreground"
      ...
      <DialogContent
        hideClose
        className="bottom-0 left-1/2 top-auto flex h-[min(92dvh,760px)] w-full max-w-3xl -translate-x-1/2 translate-y-0 flex-col gap-0 overflow-hidden rounded-b-none rounded-t-3xl p-0 data-[state=open]:slide-in-from-bottom-full! data-[state=closed]:slide-out-to-bottom-full! data-[state=open]:zoom-in-100! data-[state=closed]:zoom-out-100!"
      >
