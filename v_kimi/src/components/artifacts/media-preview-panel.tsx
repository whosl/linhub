...
export function MediaPreviewPanel({
  ...
  return (
    <motion.aside
      ...
      className="fixed inset-x-0 bottom-0 top-20 z-50 flex min-w-0 flex-col overflow-hidden rounded-t-2xl border-t bg-card/95 shadow-2xl backdrop-blur-xl lg:inset-y-0 lg:left-auto lg:right-0 lg:top-0 lg:w-[min(720px,54vw)] lg:rounded-none lg:border-l lg:border-t-0"
    >
      <div className="flex h-14 shrink-0 items-center gap-2 border-b bg-[var(--glass-bg)] px-3 backdrop-blur-[16px]">
