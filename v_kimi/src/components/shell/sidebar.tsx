    ...
    <div className="flex h-full flex-col">
      ...
      <div className="flex items-center justify-between px-3 pt-3">
        ...
        >
          ...
          <span className="text-gradient">LinHub</span>
        </Link>
      ...
      <div className="flex flex-col gap-0.5 px-3 pt-4">
        <Link
          href="/"
          className="btn-brand group flex items-center gap-2.5 rounded-xl px-2.5 py-2 text-[15px] font-medium md:text-sm"
        >
          <MessageSquarePlusIcon className="size-4" />
          新对话
          <kbd className="ml-auto hidden rounded border border-white/30 px-1 font-mono text-[10px] text-white/80 group-hover:inline">
            ⌘K
          </kbd>
        </Link>
        <button
          ...
          {NAV_ITEMS.map((item) => {
            ...
            return (
              <Link
                ...
                href={item.href}
                className={cn(
                  "relative flex items-center gap-2.5 rounded-lg px-2 py-1.5 text-[15px] text-sidebar-foreground transition-colors hover:bg-sidebar-accent md:text-sm",
                  isNavActive && "font-medium text-foreground"
                )}
              >
                {isNavActive && (
                  <motion.span
                ...
                <item.icon className={cn("relative size-4", isNavActive && "text-primary")} />
  ...
  return (
    <>
      ...
      <motion.aside
        ...
        className="glass relative z-30 hidden h-full shrink-0 overflow-hidden border-y-0 border-l-0 md:block"
      >
        ...
        return (
          <div
            ...
            className={cn(
              ...
              isActive && "bg-sidebar-accent ring-1 ring-primary/15"
            )}
          >
            <Link
              href={`/chat/${c.id}`}
