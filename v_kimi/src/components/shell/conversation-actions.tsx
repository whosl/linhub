  ...
  const triggerElement =
    trigger ?? (
      <button
        ...
        className={cn(
          "mr-1 rounded-md p-1 text-muted-foreground opacity-0 transition-all hover:bg-primary/10 hover:text-foreground focus:opacity-100 group-hover:opacity-100",
          triggerClassName
        )}
      >
