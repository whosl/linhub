    ...
    <PageContainer wide>
      ...
      {projects.length === 0 ? (
        <EmptyState
          ...
          action={<Button className="btn-brand" onClick={() => setCreateOpen(true)}>创建第一个项目</Button>}
        />
      ) : (
        <div className="grid grid-cols-1 gap-3 sm:grid-cols-2 lg:grid-cols-3">
          {projects.map((p, i) => (
            ...
            >
              ...
              >
                <Card className="card-elevated group h-full p-4">
                  <span
                    className="mb-2 flex size-10 items-center justify-center rounded-xl text-white shadow-md transition-transform duration-300 group-hover:scale-105"
