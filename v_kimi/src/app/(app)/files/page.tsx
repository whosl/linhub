              ...
              <div className="grid grid-cols-2 gap-3 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5">
                {images.map((asset, i) => (
                  <motion.div
                    ...
                    className="group relative cursor-pointer overflow-hidden rounded-xl border bg-card outline-none transition-all hover:-translate-y-0.5 hover:border-primary/40 hover:shadow-[var(--shadow-lift)] focus-visible:ring-2 focus-visible:ring-ring/40"
                  >
