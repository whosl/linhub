          ...
          <div className="mt-3 flex flex-col gap-3 pb-3 sm:flex-row sm:items-center sm:justify-between">
            <div className="flex min-w-0 flex-1 items-center gap-3">
              {editingMeta ? (
                ...
                <span
                  className="flex size-12 shrink-0 items-center justify-center rounded-xl font-serif text-lg text-white"
              ...
              <div className="overflow-hidden rounded-xl border bg-card">
                {conversations.map((c) => (
                  <Link
                    key={c.id}
                    href={`/chat/${c.id}`}
                    className="flex items-center justify-between gap-3 border-b px-4 py-3 transition-colors last:border-b-0 hover:bg-accent"
                  >
                  ...
                  <div className="space-y-2">
                    {knowledgeBases.map((kb) => {
                      ...
                      return (
                        <label
                          key={kb.id}
                          className="flex cursor-pointer items-start gap-2 rounded-lg border bg-background px-3 py-2 text-sm transition-colors hover:bg-accent"
                        >
                          <input
                            type="checkbox"
                            checked={checked}
                ...
                {project.files.length === 0 ? (
                  ...
                  <div className="space-y-2">
                    {project.files.map((f) => (
                      <div
                        key={f.id}
                        className="group/file flex items-center gap-2.5 rounded-lg border bg-background px-3.5 py-2.5"
                      >
            ...
            <div className="mx-auto max-w-3xl space-y-5">
              ...
              <section className="rounded-xl border bg-card p-4">
                ...
                {editingInstructions ? (
                  ...
                  <div className="rounded-lg border bg-background px-3 py-3 text-sm leading-relaxed text-muted-foreground">
